...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="• القائمة الرئيسية •", callback_data=f"settingsback_helper"), InlineKeyboardButton(text=_["NEXT"], callback_data=f"dilXaditi")]
