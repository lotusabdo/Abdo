...
@app.on_message(filters.command(["gban", "globalban", "حظر عام"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["ungban", "الغاء حظر عام"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedusers", "gbanlist", "محظورين عام"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
